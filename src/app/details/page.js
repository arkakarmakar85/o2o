                    ...
                    <div className="hero_in shop_detail">
                        <div className="wrapper">
                            <span className="magnific-gallery">
                                ...
                                <a href="img/gallery/hotel_list_2.jpg" title="Photo title" data-effect="mfp-zoom-in" />
                                <a href="img/gallery/hotel_list_3.jpg" title="Photo title" data-effect="mfp-zoom-in" />
                            </span>
                        </div>
                    </div>
                    {/*/hero_in*/}
                        ...
                        <div className="row">
                            ...
                            <aside className="col-lg-4" id="sidebar">
                                ...
                                <ul className="share-buttons">
                                    ...
                                    <li><a className="twitter-share" href="#0"><i className="social_twitter" /> Share</a></li>
