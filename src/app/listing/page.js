                            ...
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="col-lg-9 col-md-8 col-2">
                                        <a href="#0" className="search_mob btn_search_mobile" /> {/* /open search panel */}
                                ...
                                <ul className="clearfix">
                                    ...
                                    <li>
                                        <div className="layout_view">
                                            ...
                                            <a href="listing-2.html"><i className="icon-th-list" /></a>
                                            <a href="list-map.html"><i className="icon-map" /></a>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="strip grid">
                                                <figure>
                                                    ...
                                                    <a href="detail-restaurant.html"><img src="img/location_1.jpg" className="img-fluid" alt />
                                        ...
                                        <div className="col-md-6">
                                            <div className="strip grid">
                                                <figure>
                                                    <a href="#0" className="wish_bt" />
                                                    <a href="detail-restaurant.html"><img src="img/location_2.jpg" className="img-fluid" alt />
                                                        <div className="read_more"><span>Read more</span></div>
                                                    </a>
                                                    <small>Bar</small>
                                                </figure>
                                        ...
                                        <div className="col-md-6">
                                            <div className="strip grid">
                                                <figure>
                                                    <a href="#0" className="wish_bt" />
                                                    <a href="detail-shop.html"><img src="img/location_3.jpg" className="img-fluid" alt />
                                                        <div className="read_more"><span>Read more</span></div>
                                                    </a>
                                                    <small>Shop</small>
                                                </figure>
                                        ...
                                        <div className="col-md-6">
                                            <div className="strip grid">
                                                <figure>
                                                    <a href="#0" className="wish_bt" />
                                                    <a href="detail-restaurant.html"><img src="img/location_4.jpg" className="img-fluid" alt />
                                                        <div className="read_more"><span>Read more</span></div>
                                                    </a>
                                                    <small>Bar</small>
                                                </figure>
                                        ...
                                        <div className="col-md-6">
                                            <div className="strip grid">
                                                <figure>
                                                    <a href="#0" className="wish_bt" />
                                                    <a href="detail-hotel.html"><img src="img/location_5.jpg" className="img-fluid" alt />
                                                        <div className="read_more"><span>Read more</span></div>
                                                    </a>
                                                    <small>Hotel</small>
                                                </figure>
                                        ...
                                        <div className="col-md-6">
                                            <div className="strip grid">
                                                <figure>
                                                    <a href="#0" className="wish_bt" />
                                                    <a href="detail-restaurant.html"><img src="img/location_6.jpg" className="img-fluid" alt />
                                                        <div className="read_more"><span>Read more</span></div>
                                                    </a>
                                                    <small>Event</small>
                                                </figure>
                                                ...
                                                <ul>
                                                    <li><span className="loc_open">Now Open</span></li>
                                                    <li>
                                                        <div className="score"><span>Good<em>350 Reviews</em></span><strong>7.8</strong></div>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
