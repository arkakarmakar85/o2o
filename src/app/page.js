      ...
      <main className="pattern">
                  ...
                  <div className="col-lg-2">
                    <input type="submit" value="Search" onClick={() => {
                      ...
                      if (selectedCategory && selectedPlace) {
                        params = "?category=" + encodeURIComponent(selectedCategory.val) + "&place=" + encodeURIComponent(selectedPlace.val);
                      } else if (selectedCategory && !selectedPlace) {
                        params = "?category=" + encodeURIComponent(selectedCategory.val);
                      } else if (!selectedCategory && selectedPlace) {
                        params = "?place=" + encodeURIComponent(selectedPlace.val);
                      }
        ...
        <div className="container margin_60_35">
          <div className="main_title_3">
            ...
            <Link href="/all-services/is_popular">See all</Link>
          </div>
          ...
          <div className="main_title_3">
            ...
            {/* <p>Cum doctus civibus efficiantur in imperdiet deterruisset.</p> */}
            <Link href="/all-services/is_most_called">See all</Link>
          </div>
          <div className="row add_bottom_30">
            {called &&
              called.map((pop) => {
